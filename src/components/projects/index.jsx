    ...
    >
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 md:grid-cols-3 gap-4 justify-items-center items-center grid-cols-1">
        <ProjCard
          url="#"
          name="BystroSync"
          description="A mobile app for online restaurant reservations and pre-orders"
        ...
        <ProjCard
          ...
          name="This Portfolio"
          description="The source code for this portfolio, built and hosted on the vercel platform"
        ...
        <ProjCard
          ...
          description="Development of a mobile and web app for the investors of the real estate investment company S7equity."
          technologies="React Native, expo"
        ...
        <ProjCard
          ...
          description="Development of the front-end for the “Tunisian Modern Newspaper” website to display news, blogs and podcasts"
        ...
        <ProjCard
          ...
          name="Handyman"
          description="A mobile app that helps people find and contact workers near them"
        ...
        <ProjCard
          ...
          description="Config Generator is a tool that helps with generating config files like dockerfiles and bash scripts with dynamic inputs"
          technologies="NextJS, tailwind CSS"
