    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-12 justify-center items-start md:items-center">
        <div className="flex gap-4 flex-col">
          <InfoItem
            link="mailto:bougadouha.malek@gmail.com"
            icon={<HiOutlineMail size={26} color="#84cc16" />}
            text="bougadouha.malek@gmail.com"
          />
          <InfoItem
            link="tel:+21628064787"
            icon={<HiOutlinePhone size={26} color="#84cc16" />}
            text="+216 28 064 787"
          />
        </div>
        <div className="flex gap-4 flex-col">
          <InfoItem
            link="https://www.linkedin.com/in/malek-bougadouha/"
            icon={<BsLinkedin size={26} color="#84cc16" />}
            text="malek-bougadouha"
          />
          <InfoItem
            link="https://github.com/malekbougadouha/"
            icon={<BsGithub size={26} color="#84cc16" />}
            text="malekbougadouha"
          />
        </div>
      </div>
    </div>
